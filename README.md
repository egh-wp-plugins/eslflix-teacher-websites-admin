# ESLFlix Teacher Websites Admin

WordPress administration tools for preparing ESLFlix teacher website accounts.

## Features

- Search WordPress users by username, email address, display name, or user ID.
- Generate a unique, single-use teacher website builder code.
